...
# Form implementation generated from reading ui file 'RegistroW.ui'
#
...
"font: 700 14pt \"Arial\";")
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(60, 111, 221, 201))
        ...
        self.txt_password_2 = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.txt_password_2.setEchoMode(QtWidgets.QLineEdit.Password)
        self.txt_password_2.setObjectName("txt_password_2")
        self.verticalLayout.addWidget(self.txt_password_2)
        self.label_6 = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.label_6.setStyleSheet("font: 14pt \"Arial\";")
        self.label_6.setObjectName("label_6")
        self.verticalLayout.addWidget(self.label_6)
        self.txt_telefono = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.txt_telefono.setObjectName("txt_telefono")
        self.verticalLayout.addWidget(self.txt_telefono)
        self.btnRegistrar = QtWidgets.QPushButton(self.centralwidget)
        self.btnRegistrar.setGeometry(QtCore.QRect(120, 340, 101, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.txt_password_2.setPlaceholderText(_translate("MainWindow", "Confirme la contraseña."))
        self.label_6.setText(_translate("MainWindow", "-Teléfono:"))
        self.txt_telefono.setPlaceholderText(_translate("MainWindow", "Introduce el  teléfono."))
        self.btnRegistrar.setText(_translate("MainWindow", "Registrar usuario"))
        self.btnRegistrar.setShortcut(_translate("MainWindow", "Return"))
